...
Well, you may have guessed it by now, but to be clear: you need to create a fibonacci function that given a _signature_ array/list, _returns the first n elements - signature included_ of the so seeded sequence.
